...
class ScoringAdapter : public TennisScoring, public NumericScoring
{
public:
    void addPlayer1Scores() override { addPointToPlayer1(); }
    void addPlayer2Scores() override { addPointToPlayer2(); }

    std::string getScore() override
    {
        int p1 = getPlayer1Points();
        int p2 = getPlayer2Points();
...
int main()
{
    std::cout << "Class Adapter Pattern Demo" << std::endl;

    const auto scoring = std::make_unique<ScoringAdapter>();
